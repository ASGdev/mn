...
void mncblas_dgemv (MNCBLAS_LAYOUT Layout, MNCBLAS_TRANSPOSE trans, const int m, const int n, const double alpha, const double *a, const int lda, const double *x, const int incx, const double beta, double *y, const int incy){
    //y := alpha*A*x + beta*y,
    register unsigned int i = 0 ;
    register unsigned int j = 0 ;
